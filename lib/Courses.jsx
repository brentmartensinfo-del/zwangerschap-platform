  ...
  const POPULAR_COURSES = [
    {
      ...
      descriptionLong: 'Bij Mom & Co geloven we dat een goede voorbereiding op de bevalling het verschil maakt — niet alleen lichamelijk, maar ook mentaal en emotioneel. Onze cursussen zijn ontwikkeld door een team van ervaren verloskundigen en zijn erop gericht om jou en je partner écht klaar te stomen voor de komst van jullie baby.\n\nTijdens de cursus verkennen we alle facetten van de zwangerschap en bevalling: van de fysiologie van weeën tot effectieve ademhalingstechnieken, van ontspanningsoefeningen tot de praktische rol van de partner in de verloskamer. Alles in een veilige, open sfeer waarin vragen stellen vanzelfsprekend is.\n\nOns programma combineert wetenschappelijke inzichten met praktische tools die je direct kunt toepassen. Je gaat naar huis met niet alleen kennis, maar ook met een dieper vertrouwen in je eigen lichaam en in het proces van de bevalling.',
      price: '€ 145',
      bookingUrl: 'https://studiovesper.nl/zwangerschapsyoga',
      type: 'Zwangerschapsyoga',
      city: 'Amsterdam',
      language: 'Nederlands',
      curriculum: [
        { period: 'Week 1-2', title: 'Basis, Houding & Ademhaling',   body: 'We starten met een kennismaking, theorie over de ademhaling en het vinden van de juiste basishouding nu je buik begint te groeien. Je leert de eerste ontspanningsoefeningen.' },
        { period: 'Week 3-4', title: 'Kracht & Bekkenbodem',          body: 'Focus op het versterken van de spieren rondom je bekken en rug. We besteden veel aandacht aan het bewust aanspannen en ontspannen van de bekkenbodemspieren.' },
        { period: 'Week 5-6', title: 'Omgaan met Weeën & Pijn',       body: 'Praktische technieken om weeën op te vangen. Je leert welke houdingen bevorderlijk zijn voor de ontsluiting en hoe je diepe ademhaling inzet als pijnstilling.' },
        { period: 'Week 7-8', title: 'Bevalling & Kraamtijd',         body: 'De laatste voorbereidingen. We bespreken het moment van persen, houdingen tijdens de geboorte en we sluiten af met focus op herstel in de eerste weken na de bevalling.' },
      ],
      learningItems: [
        'Diepe ademhalingstechnieken voor pijnverlichting tijdens weeën.',
        'Versterken van bekkenbodem en rug om klachten te voorkomen.',
      ...
      practical: [
        { icon: 'lucide:map-pin',      title: 'Locatie',       body: 'Studio Vesper \nKinkerstraat 123 \n1053 EB Amsterdam' },
        { icon: 'lucide:car',          title: 'Parkeren',      body: 'Betaald parkeren in de straat. Fietsen kunnen direct voor de deur veilig geplaatst worden.' },
        { icon: 'lucide:shopping-bag', title: 'Zelf meenemen', body: 'Trek comfortabele kleding aan. Matjes, kussens en dekentjes zijn ruim aanwezig in de studio.' },
      ],
      quickInfo: [
        { icon: 'lucide:calendar-clock', label: 'Duur',          value: '1 dag (8 uur les)' },

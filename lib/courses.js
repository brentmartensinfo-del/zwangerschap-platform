  ...
  const POPULAR_COURSES = [
    {
      ...
      language: 'Nederlands',
      curriculum: [
        { period: '4 weken', title: 'De 4-weekse zwangerschapscursus',   body: 'Mom & co’s ultieme en super uitgebreide zwangerschapscursus, waar we je álles leren wat we weten. Met opdrachten voor thuis, veel ruimte voor vragen en 4 gezellige, informatieve bijeenkomsten is er zowel veel te doen als op te steken, met veel verbinding en herkenning.' },
        { period: '2 weken', title: 'De 2 weken durende zwangerschapscursus',          body: 'Bereid je volledig voor op de bevalling met twee uitgebreide sessies en opdrachten voor de ‘datenight’ tussendoor thuis. Deze 2 weken durende zwangerschapscursus is ook zeer complete, maar iets meer gefocussed.' },
        { period: '1 dag', title: 'De 1-daagse zwangerschapscursus (incl. lunch)',       body: 'Samen één dag knallen, tijdens een gezellige, informatieve en iets intensiever dan de andere cursussen. Dat is de 1 daagse zwangerschapscursus van Mom & co. Een echte stoomcursus, samen met de andere deelnemers ‘deep-diven’ en de babymodus écht aan switchen. Inclusief gezellige en gezonde lunch!' },
        { period: 'Persoonlijk', title: 'De privé zwangerschapscursus',         body: 'In de comfort van je eigen huis komt één van onze verloskundigen bij je langs, om een ‘tailor-made’ sessie van drie uur te geven die je samen van te voren hebt voorbereid, om zo je specifieke wensen en vragen te tackelen.' },
